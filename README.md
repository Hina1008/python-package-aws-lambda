...
aws lambdaでOS依存のパッケージをLayerにアップロードしライブラリを使えるようにするための環境作り.\
...
└── docker-compose.yml
```
# 3.requirements.txtにインストールしたいライブラリ名を記述する.
...
```
# 5.python以下をzipで圧縮をする.(アプリで圧縮する場合は,６へ)
